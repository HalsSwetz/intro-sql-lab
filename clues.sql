...
SELECT name, population, code FROM countries WHERE region = 'Southern Europe' ORDER BY population ASC LIMIT 1;
...
-- Write SQL query here
SELECT name FROM countries, countrylanguages WHERE countries.code = countrylanguages.countrycode
 AND countrylanguages.language = 'Italian' AND countrylanguages.percentage = 100;
